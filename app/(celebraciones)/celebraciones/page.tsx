  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-3xl px-6 py-12">
        <h2 className="text-2xl font-bold text-amber-900">Cumpleaños de adultos</h2>
      ...
      <section className="mx-auto max-w-3xl px-6 py-12">
        <h2 className="text-2xl font-bold text-amber-900">Fincas y espacios especiales</h2>
        <p className="mt-3 text-lg leading-relaxed text-slate-700">
      ...
      <section className="mx-auto max-w-3xl px-6 py-12">
        <h2 className="text-2xl font-bold text-amber-900">Otros eventos especiales</h2>
        <p className="mt-3 text-lg leading-relaxed text-slate-700">
      ...
      <section className="mx-auto max-w-xl px-6 pt-12 text-center">
        <h2 className="text-2xl font-bold text-amber-900">Cuéntanos tu celebración</h2>
