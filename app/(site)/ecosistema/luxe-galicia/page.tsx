...
const comoTrabajamos = [
  {
    ...
    texto:
      "Coordinas con Mil Eventos Galicia, y nosotros coordinamos con Luxe Galicia — nunca tienes que negociar tú directamente con una empresa de transporte.",
  },
  {
...
export default function LuxeGaliciaPage() {
  return (
    <>
      <Hero
        titulo="Luxe Galicia"
        subtitulo="Transporte y desplazamientos para eventos de empresa en toda Galicia."
      />
      ...
      <section className="mx-auto max-w-3xl px-6 py-12 text-lg leading-relaxed text-ink-700">
        ...
        <p className="mt-4">
          ...
          especializados moviendo a tu grupo de un punto a otro.
        </p>
        <p className="mt-4">
          Esta página explica qué hace Luxe Galicia y cuándo tiene sentido incluirla en tu evento
        ...
        <p className="mt-4">
          ...
          actividad principal, no como un trámite de última hora.
        </p>
        <p className="mt-4">
          Cincuenta personas esperando un autobús que no llega arruinan la percepción de un evento
          perfectamente organizado en todo lo demás, y es de las cosas más fáciles de evitar si se
          planifica con tiempo suficiente.
        </p>
        <p className="mt-4">
          Por eso lo tratamos como una pieza más del evento, no como un extra que se resuelve al
          final cuando ya está todo lo demás cerrado.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        ...
        <p className="mt-3 max-w-2xl leading-relaxed text-ink-700">
          Cuatro tipos de traslado, cada uno con su propia lógica de coordinación según el tamaño
          del grupo y el programa completo del evento.
        </p>
        <div className="mt-6">
      ...
      <section className="bg-cream-200 py-12">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-3 max-w-2xl leading-relaxed text-ink-700">
            ...
            pasa a ser parte central de la planificación.
          </p>
          <div className="mt-6">
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="mt-3 max-w-2xl leading-relaxed text-ink-700">
          ...
          funciona como una extensión del mismo equipo que organiza tu evento, con el mismo
          criterio.
        </p>
        <div className="mt-6">
      ...
      <section className="mx-auto max-w-3xl px-6 py-12 text-lg leading-relaxed text-ink-700">
        ...
        <p className="mt-3">
          El transporte no es una actividad más del catálogo — es una pieza de logística que
          entra o no entra en juego según el tipo y el tamaño de cada evento.
        </p>
        <p className="mt-4">
          Tiene sentido para cualquier{" "}
          ...
          mismo día, y para cualquier evento con un volumen de personas que hace inviable que cada
          uno llegue por su cuenta.
        </p>
        <p className="mt-4">
          Si tu evento es pequeño y todos los asistentes son locales, probablemente no necesites
          nada de esto — y te lo diremos así, en lugar de proponerte un servicio que no aporta
          nada real al programa.
        </p>
        <p className="mt-4">
          Y si el programa combina transporte con alojamiento o actividades de varios días,
      ...
      <CTAFinal
        titulo="La logística que no se ve es la que mejor está funcionando de verdad."
